    ...
    <>
      ...
      <Section  className="py-16">
        ...
        <div className="w-full flex items-center justify-center bg-[#FFEFED] p-16 rounded-lg mt-3">
          <h1 className="text-5xl lg:text-8xl font-bold bg-white border-18 lg:border-24 border-[#FF6347] rounded-full h-50 w-50 lg:h-100 lg:w-100 flex flex-col items-center justify-center text-center gap-y-1.5">
